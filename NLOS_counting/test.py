...
train_dataset, val_dataset = split_dataset(
    # dataset_root='/mnt/petrelfs/share_data/lisibo/NLOS/data_render_mot/2', # Fill your dataset root!
    dataset_root = "../NLOS/dataset/render",
    train_ratio=0,
    route_len=160,
    data_type = "render"
    )
...
for idx, (gt, pred) in enumerate(zip(gt_routes.cpu().numpy(), pred_routes.cpu().numpy())):
    ...
    cv2.imwrite(f"./test/test_dataset/{idx}.png", fig)
